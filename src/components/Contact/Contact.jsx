  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && (data.success === "true" || data.success === true)) {
        ...
        // If unactivated yet, FormSubmit sends activation link to Gmail
        alert("Form submitted! Please check your Gmail (" + socialLinks.email + ") and click 'Activate Form' link to start receiving messages for lifetime.");
        setSubmitted(true);
        setTimeout(() => {
          setSubmitted(false);
          setFormData({ name: '', email: '', phone: '', subject: '', message: '' });
            ...
            <div className={styles.detailsList}>
              <div className={`${styles.detailCard} glass-card`}>
                ...
                <div>
                  ...
                  <a href={`mailto:${socialLinks.email}`} className={styles.detailValue}>
                    {socialLinks.email}
                  </a>
                </div>
              </div>
